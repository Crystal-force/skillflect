...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Student This Week Data</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
	...
	<div class="main-content">
      ...
      <div class="col-md-9 col-xs-12">
        ...
        <div class="form-group margin-bottom-20 select-subject">
          <select class="form-control" id="chart_weekid">
        ...
        <div class="box-content">
          ...
          <form id="commentForm" action="#">
            <div id="tabsleft" class="tabbable tabs-left">
              <ul>
                <li><a href="#tabsleft-tab1" data-toggle="tab">This Week</a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane" id="tabsleft-tab1">
                  <div class="box-content">
                    <div id="donut-morris-chart-week" class="morris-chart" style="height: 320px"></div>
               ...
               <div class="row col-lg-12 sbj_notification">
                ...
                <div class="col-lg-6">
                    <div class="alert alert-info" id="week_result" role="alert"> <strong>Heads up!</strong> There is no data to display. You can choose a different topic again. </div>
                </div>
                <div class="col-lg-3"></div>
              </div>
              {{-- Notification --}}
