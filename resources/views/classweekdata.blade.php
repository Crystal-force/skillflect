	...
	<div class="main-content">
      ...
      <div class="col-md-9 col-xs-12">
        ...
        <div class="form-group margin-bottom-20 select-subject overall-subject">
          <select class="form-control" id="class_weekid">
            ...
            <div id="tabsleft" class="tabbable tabs-left">
              ...
              <div class="tab-content">
                <div class="tab-pane" id="tabsleft-tab1">
                  <div class="box-content">
                    <div id="donut-morris-chart-classweek" class="morris-chart" style="height: 320px"></div>
              ...
              <div class="row col-lg-12 sbj_notification">
                ...
                <div class="col-lg-6">
                    <div class="alert alert-info" id="week_notification" role="alert"> <strong>Heads up!</strong> There is no data to display. You can choose a different topic again. </div>
                </div>
                <div class="col-lg-3"></div>
              </div>
              {{-- Notification --}}
