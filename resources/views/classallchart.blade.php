	...
	<div class="main-content">
      ...
      <div class="col-md-9 col-xs-12">
        ...
        <div class="form-group margin-bottom-20 select-subject overall-subject">
          <select class="form-control" id="class_allid">
              <option value="0">All</option>
              @foreach($tch_sbj as $Subject)
              <option  value="{{$Subject->name}}" data-id={{$Subject->id}}>{{$Subject->name}}</option>
              @endforeach
          </select>
          <button type="button" class="btn btn-info waves-effect waves-light" onclick="TotalDataView();">View</button>
        </div>
        <div class="box-content">
          <div class="data-submenu sub-menu">
            ...
            <a href="/classmonth?id={{$ClassUser->id}}" class="thisweek-btn">This Month</a>
            @endforeach
            </div>
          </div>
            ...
            <div id="tabsleft" class="tabbable tabs-left">
              ...
              <div class="tab-content">
                <div class="tab-pane" id="tabsleft-tab1">
                  <div class="box-content">
                    <div id="donut-morris-chart-classall" class="morris-chart" style="height: 320px"></div>
              ...
              <div class="row col-lg-12 sbj_notification">
                ...
                <div class="col-lg-6">
                    <div class="alert alert-info" id="all_notification" role="alert"> <strong>Heads up!</strong> There is no data to display. You can choose a different topic again. </div>
                </div>
                <div class="col-lg-3"></div>
              </div>
              {{-- Notification --}}
        ...
        <div class="box-content detail-table">
          <div class="table-header">
            <h4 class="box-title">Histroy</h4>
            <a href="#" class="close-table" onclick="Close_Table();"><i class="menu-icon mdi mdi-window-close" style="font-size: 26px"></i> </a>
          </div>
            <!-- /.dropdown js__dropdown -->
